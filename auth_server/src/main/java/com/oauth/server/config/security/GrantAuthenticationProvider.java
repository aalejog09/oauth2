...
@Slf4j
public class GrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public GrantAuthenticationProvider(OAuth2AuthorizationService authorizationService,
                                       OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator, CustomUserDetailsService userDetailsService,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        GrantAuthenticationToken customCodeGrantAuthentication = (GrantAuthenticationToken) authentication;
        ...
        if (!passwordEncoder.matches(password, user.getPassword()) || !user.getUsername().equals(username)) {
            log.info("password does not matches");
            throw new OAuth2AuthenticationException(OAuth2ErrorCodes.ACCESS_DENIED);
        }
    ...
    public boolean supports(Class<?> authentication) {
        return GrantAuthenticationToken.class.isAssignableFrom(authentication);
    }
